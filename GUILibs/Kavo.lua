...
function Kavo.CreateLib(kavName, themeList)
	...
	close.MouseButton1Click:Connect(function()
		game.TweenService
			:Create(close, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
				ImageTransparency = 1,
			})
			:Play()
		wait()
		game.TweenService
			:Create(Main, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
	...
	tabFrames.Position = UDim2.new(0.0438990258, 0, -066378375, 0)
	...
	function Tabs:NewTab(tabName)
		...
		local function UpdateSize()
			...
			game.TweenService
				:Create(page, TweenInfo.new(0.15, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
		...
		function Sections:NewSection(secName, hidden)
			...
			function Elements:NewButton(bname, tipINf, callback)
				...
				btn.MouseEnter:Connect(function()
					if not focusing then
						game.TweenService
							:Create(btn, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
			...
			function Elements:NewToggle(tname, toggled, nTip, callback)
				local TogFunction = {}
			...
			function Elements:NewSlider(slidInf, slidTip, startVal, minvalue, maxvalue, callback)
                ...
                sliderDrag.Size = UDim2.new(0, (startVal-minvalue)*(149/(maxvalue-minvalue)), 0, 6)

				local Value
				sliderBtn.MouseButton1Down:Connect(function()
					if not focusing then
						game.TweenService
							:Create(val, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
								TextTransparency = 0,
							})
							:Play()
						Value = math.floor(
			...
			function Elements:NewKeybind(keytext, keyinf, first, callback, callback2)
				...
				keybindElement.MouseEnter:Connect(function()
					if not focusing then
						game.TweenService
							:Create(keybindElement, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
								BackgroundColor3 = Color3.fromRGB(
									themeList.ElementColor.r * 255 + 8,
									themeList.ElementColor.g * 255 + 9,
									themeList.ElementColor.b * 255 + 10
			...
			function Elements:NewColorPicker(colText, colInf, defcolor, callback)
				...
				colorElement.MouseEnter:Connect(function()
					if not focusing then
						game.TweenService
							:Create(colorElement, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
								BackgroundColor3 = Color3.fromRGB(
									themeList.ElementColor.r * 255 + 8,
									themeList.ElementColor.g * 255 + 9,
									themeList.ElementColor.b * 255 + 10
